...
public class WaterArrowProjectile extends Projectile {
    ...
    // Schaden, den der Wasserpfeil verursacht
    private final float damage;

    // Anzahl der Gegner, die der Pfeil noch durchdringen kann
    ...
    public void onHit(Enemy enemy) {
        ...
        // die der Pfeil noch durchdringen kann.
        pierceLeft--;
